...
float getEarthAccX(MPU9250_t *MPU9250)	{ return MPU9250->earth_acc[0]; }
float getEarthAccY(MPU9250_t *MPU9250)	{ return MPU9250->earth_acc[1]; }
float getEarthAccZ(MPU9250_t *MPU9250)	{ return MPU9250->earth_acc[2]; }

float getLonAcc(MPU9250_t *MPU9250) { return MPU9250->long_acc; }

float getEarthGyroX(MPU9250_t *MPU9250) { return MPU9250->earth_gyro[0]; }
float getEarthGyroY(MPU9250_t *MPU9250) { return MPU9250->earth_gyro[1]; }
float getEarthGyroZ(MPU9250_t *MPU9250) { return -MPU9250->earth_gyro[2]; }
...
void update_rpy(MPU9250_t *MPU9250, float qw, float qx, float qy, float qz){
	...
	float a11, a12, a13, a21, a22, a23, a31, a32, a33;  // rotation matrix coefficients for Euler angles and gravity components
	        ...
	        MPU9250->rpy[0] = atan2f(a32, a33);
	        MPU9250->rpy[1] = -asinf(a31);
	        MPU9250->rpy[2] = atan2f(a21, a11);
	        ...
	        if (MPU9250->rpy[2] < 0) MPU9250->rpy[2] += 360.f;
	        ...
	        MPU9250->earth_acc[0] = a11*MPU9250->lin_acc[0] + a12*MPU9250->lin_acc[1] + a13*MPU9250->lin_acc[2];
	        MPU9250->earth_acc[1] = a21*MPU9250->lin_acc[0] + a22*MPU9250->lin_acc[1] + a23*MPU9250->lin_acc[2];
	        MPU9250->earth_acc[2] = a31*MPU9250->lin_acc[0] + a32*MPU9250->lin_acc[1] + a33*MPU9250->lin_acc[2];

	        MPU9250->earth_gyro[0] = (a11*MPU9250->g[0] + a12*MPU9250->g[1] + a13*MPU9250->g[2])* DEG_TO_RAD;
	        MPU9250->earth_gyro[1] = (a21*MPU9250->g[0] + a22*MPU9250->g[1] + a23*MPU9250->g[2])* DEG_TO_RAD;
	        MPU9250->earth_gyro[2] = (a31*MPU9250->g[0] + a32*MPU9250->g[1] + a33*MPU9250->g[2])* DEG_TO_RAD;

	        MPU9250->long_acc = sqrt(MPU9250->earth_acc[0]*MPU9250->earth_acc[0]+MPU9250->earth_acc[1]*MPU9250->earth_acc[1]);
