...
float getLonAcc(MPU9250_t *MPU9250);

float getEarthAccX(MPU9250_t *MPU9250);
float getEarthAccY(MPU9250_t *MPU9250);
float getEarthAccZ(MPU9250_t *MPU9250);

float getEarthGyroX(MPU9250_t *MPU9250);
float getEarthGyroY(MPU9250_t *MPU9250);
float getEarthGyroZ(MPU9250_t *MPU9250);
